  ...
  return (
    <>
      <Button
        ...
        disabled={isFinalizado || isRechazado || isLoading}
      >
        Finalizar
      </Button>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed z-50 inset-0 m-auto flex max-w-lg items-center justify-center">
            <div className="bg-gray-700 p-6 rounded-lg shadow-lg">
              ...
              <DialogFooter>
                <Button onClick={HandleUpdate} disabled={isFinalizado}>
                  Confirmar
                </Button>
      ...
      {isFinalizado && <p className="text-green-600">El ticket ha sido finalizado.</p>}
    </>
  );
}